package com.hika.user.features.cart
...
import com.hika.user.databinding.FragmentCartBinding
import com.hika.user.features.payment.PaymentActivity
...
class CartFragment : BaseFragment<FragmentCartBinding>() {
    ...
    override fun FragmentCartBinding.bind() {
        ...
        val cartAdapter = com.hika.user.adapter.CartAdapter(
            onIncreaseAmount = { productId, name, price, image ->
                viewModel.addItem(
                    productId,
                    name,
                    price,
            ...
            onCheckedChange = { productId, isChecked ->
